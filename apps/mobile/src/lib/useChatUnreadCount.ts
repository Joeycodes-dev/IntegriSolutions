...
import { hasSupabaseRealtimeConfig, supabaseRealtime } from './supabaseRealtime';
  ...
  useEffect(() => {
    ...
    const refresh = async () => {
      try {
        ...
        // Ignore temporary errors so navigation remains responsive.
      }
    };
